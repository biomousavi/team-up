...
<template>
  <div class="d-flex rounded-lg bg-surface w-100 pa-2">
    <div class="d-flex justify-space-between align-center w-100">
      <h2 class="text-body-1">In-call message</h2>

      <v-btn class="mx-2" variant="text" @click="onToggleChat" :icon="mdiWindowClose"></v-btn>
    </div>
  </div>

  <div class="messages d-flex flex-column justify-space-between rounded-lg bg-surface w-100 pa-2 pb-4 mt-2">
    <!-- Message List -->
    <div ref="wrapper" class="scroll-region h-100 overflow-y-auto">
      <!-- Message Header -->
      <p class="d-block bg-surface-variant text-medium-emphasis pa-2 rounded-lg">
        Messages can be seen only by people in the call and are deleted when the call ends
      </p>

      <ul class="message-list bg-surface pb-8">
        <XyzTransitionGroup xyz="fade down appear-stagger">
          ...
          >
            ...
            <div class="d-flex flex-column">
              ...
              <p class="bg-surface-variant rounded-lg pa-2">{{ message.text }}</p>
            </div>
          </li>
    ...
    <!-- Message Input -->
    <div class="d-flex justify-space-between align-center bg-surface-variant rounded-pill">
      <textarea
